...
// HTML Control Panel with session management - MODIFIED FOR WASU  COOKIES TOOL
...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1 class="title">🍺 WASU  COOKIES TOOL 🍺</h1>
        ...
        <div class="logs-container">
            ...
            <div class="logs-box" id="logsBox">
                ...
                <div class="log-entry log-info">🔧 WASU  COOKIES TOOL INITIALIZED...</div>
        ...
        <!-- Footer -->
        <div class="footer">
            <div>🍺 THIS TOOL MADE BY MR WASU  = 2025 🍺</div>
    ...
    <script>
        ...
        window.addEventListener('load', () => {
            ...
            // Add initial log
            addLog('WASU  COOKIES TOOL READY', 'success');
        });
...
const server = app.listen(PORT, () => {
  console.log(`🍺 WASU  COOKIES TOOL running at http://localhost:${PORT} 🍺`);
});
...
wss.on('connection', (ws) => {
  ...
  if (ws.readyState === WebSocket.OPEN) {
    ws.send(JSON.stringify({ 
      type: 'log', 
      message: 'Connected to WASU  COOKIES TOOL',
      level: 'success'
    }));
  }
});
...
process.on('SIGINT', () => {
  console.log('Shutting down WASU  COOKIES TOOL...');
